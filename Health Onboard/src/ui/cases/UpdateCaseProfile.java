 ...
 * @author jhalaksurve
 */
public class UpdateCaseProfile extends javax.swing.JPanel {
     ...
     */
    public UpdateCaseProfile(JPanel userProcessContainer, User user, UserDirectory userDirectory) {
        initComponents();
        ...
        userNameTxtField.setText(user.getName());
...
//        Color c2 = Color.white;
    ...
    private void saveJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveJButtonActionPerformed
             ...
             zipCodeField.getText()!=null && !zipCodeField.getText().isEmpty())
        {
            try
            {
                 if(!(user.getName().equals(userNameTxtField.getText()))&&!(userDirectory.checkUniqueName(userNameTxtField.getText())))
                    {
                  ...
                  int age = Validations.ageCalculation(dateOfBirthVal);
                   if(age<12)
                    ...
                    user.setName(userNameTxtField.getText());
