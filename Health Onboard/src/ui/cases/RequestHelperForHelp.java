...
public class RequestHelperForHelp extends javax.swing.JPanel {
     ...
     */
    public RequestHelperForHelp (JPanel userProcessContainer, User user, Helper helper, HelperOrganizations organizations,Environment environment) {
        initComponents();
...
//        Color c2 = Color.white;
     ...
     for(Request request : user.getRequestPipeline().getRequestList())
        {
         if(request.getReqMessage().equalsIgnoreCase("Need Help"))
         {
           ...
           rowData[0] = ((HelpRequest)request).getReqId();
           rowData[1] = ((HelpRequest)request).getHelp().getHelp();
           rowData[2] = dateFormat.format(request.getRequestDate());
           rowData[3] = request.getReceiverDetails() == null ? null : request.getReceiverDetails().getName() ;
           rowData[4] = request.getStatusOfRequest();
    ...
    public void populateNeedHelpListTable()
    {
        ...
        for(Help nh : environment.getHelpList() )
        {
    ...
    private void initComponents() {
        ...
        manageEnt1.setText("Required Help not present :");
        ...
        workRequestHistoryTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request ID", "Help Recieved", "Requested Date", "Helper ID", "Status"
            }
        ) {
        ...
        manageEnt5.setText("Request Helper For Help:");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(manageEnt1, javax.swing.GroupLayout.PREFERRED_SIZE, 267, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(262, 262, 262)
                        .addComponent(manageEnt2, javax.swing.GroupLayout.PREFERRED_SIZE, 310, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(49, 49, 49)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void createRequestButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createRequestButtonActionPerformed
       ...
       JOptionPane.showMessageDialog(this, "Please Enter data in all the fields ", "warning", JOptionPane.PLAIN_MESSAGE);
        ...
        needHelp = (Help)helpjTable.getValueAt(selectedRow, 0);
         }
       
        SubmitHelpRequest submitHelpRequest = new SubmitHelpRequest(userProcessContainer, user,helper, needHelp, organizations);
