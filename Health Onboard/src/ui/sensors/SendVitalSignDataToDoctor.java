...
public class SendVitalSignDataToDoctor extends javax.swing.JPanel {
    ...
    private DoctorOrganizations doctorOrganizations;
    /**
     * Creates new form SendVitalSignDataToDoctorPanel
     */
    public SendVitalSignDataToDoctor(JPanel userProcessContainer, User user, Environment environment) {
        initComponents();
...
//        Color c2 = Color.white;
    ...
    private void sendDataTodctrBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendDataTodctrBtnActionPerformed
        ...
        try
        {
            ...
            if(sendToDoctorYesRad.isSelected())
            {
                ...
                User docAccount = (User) doctorComboBx.getSelectedItem();
                String medicatnTxt = currentMedicationsTxtArea.getText().replaceAll("\n", " ");
                
                SendDataToDoctorRequest sendDataToDoctorRequest = new SendDataToDoctorRequest();
                sendDataToDoctorRequest.setReqMessage("Vital Sign Data");
                sendDataToDoctorRequest.setSenderDetails(user);
                ...
                user.getRequestPipeline().getRequestList().add(sendDataToDoctorRequest);
    ...
    public void populateDoctorComboBx()
    {
       ...
       {
        doctorComboBx.removeAllItems();
        doctorOrganizations =  Validations.getDoctorOrganizations(environment, user);
   //    System.out.println("doctorOrganization"+doctorOrganization.getName());
       if(doctorOrganizations!=null)
       {
        if(doctorOrganizations.getUserDirectory().getUserList().isEmpty())
        {
        JOptionPane.showMessageDialog(null, "No doctors exists in our records as of now!","warning", JOptionPane.WARNING_MESSAGE);
         return;    
        }
         doctorComboBx.removeAllItems();
        for(User user : doctorOrganizations.getUserDirectory().getUserList())
        {
        doctorComboBx.addItem(user);
        }   
       }
       }
