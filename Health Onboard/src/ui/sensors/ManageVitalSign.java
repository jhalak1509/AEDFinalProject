...
import businessFramework.enterprises.CharityEnterprises;
...
public class ManageVitalSign extends javax.swing.JPanel {
     ...
     */
    public ManageVitalSign(JPanel userProcessContainer, User user, Environment environment) {
        initComponents();
     ...
     if(person.isShareVital() && person.isHasSensor())
     {
       ...
       if(person.isShareVital() && !person.isHasSensor())
       {
        ...
        if(!(user.getRequestPipeline().getRequestList().isEmpty()))
                ...
                {
                   if(request.getReqMessage().equalsIgnoreCase("Need Sensor Device"))
                   {
      ...
      try
      {
        for(Network network : environment.getNetworkList())
        {
          ...
          {
              if(enterprises instanceof CharityEnterprises)
              {
              if(enterprises.getOrganizationsDirectory().getOrganizationsList().isEmpty())
              {
             ...
             return;       
              ...
              for(Organizations org : enterprises.getOrganizationsDirectory().getOrganizationsList())
              {
      ...
      catch(NullPointerException npe)
      {
       JOptionPane.showMessageDialog(null, "Non Profit Enterprise does not exist as of now ","warning", JOptionPane.WARNING_MESSAGE);
        ...
        user.getRequestPipeline().getRequestList().add(nsdwr);
