...
public class DoctorWorkArea extends javax.swing.JPanel {
        ...
        private User user;
        private SendDataToDoctorRequest sdtdwr;
    /**
     * Creates new form DoctorWorkAreaJPanel
     */
    public DoctorWorkArea(JPanel userProcessContainer, User user) {
        initComponents();
    ...
    public void populateHelpSeekerComboBx()
    {
     ...
     for(Request request : user.getRequestPipeline().getRequestList())
        {
        if(!request.getReqMessage().equalsIgnoreCase(ManagerRequest.REQUEST_APPROVAL))
        {
         String customer = (String)request.getSenderDetails().getName();
       ...
       for(String s1 : hsstateVal)
        {
         for(Request request : user.getRequestPipeline().getRequestList())
        {
         String userName = (String)request.getSenderDetails().getName();
       if(userName.equals(s1))
       {
        Case customer = (Case)request.getSenderDetails().getPerson();
    ...
    private void initComponents() {
        ...
        getDataForPatient.setBackground(new java.awt.Color(0, 153, 153));
        ...
        sendNewMedicationsBtn.setBackground(new java.awt.Color(0, 153, 153));
        ...
        viewDetailsJButton.setBackground(new java.awt.Color(0, 153, 153));
    ...
    private void getDataForPatientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getDataForPatientActionPerformed
       ...
       Case customer = (Case)helpSeekerComboBx.getSelectedItem();
        ...
        for(Request request : user.getRequestPipeline().getRequestList())
        {
         if(!(request.getReqMessage().equalsIgnoreCase(ManagerRequest.REQUEST_APPROVAL)))
         {
         Case cust = (Case)request.getSenderDetails().getPerson();
         if(cust.equals(customer))
         {
         sdtdwr = (SendDataToDoctorRequest)request;    
    ...
    private void sendNewMedicationsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendNewMedicationsBtnActionPerformed
        ...
        if(sdtdwr.getStatusOfRequest().equalsIgnoreCase("Completed"))
        {
         ...
         sdtdwr.setStatus(ManagerRequest.REQUEST_COMPLETED);
    ...
    private void viewDetailsJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailsJButtonActionPerformed
     ...
     public void populateVitalSignsJTable(Case customer)
    {   
        try
        {
        ...
        int age = Validations.ageCalculation(customer.getDob());
