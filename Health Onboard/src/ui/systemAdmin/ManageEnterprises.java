...
public class ManageEnterprises extends javax.swing.JPanel {
     ...
     */
    public ManageEnterprises(JPanel userProcessContainer, Environment system) {
        initComponents();
...
//        Color c2 = Color.white;
    ...
    private void populateEnterpriseTable() {
        ...
        for (Network network : system.getNetworkList()) {
            for (Enterprises enterprises : network.getEnterprisesDirectory().getEnterprisesList()) {
                ...
                row[2] = enterprises.getEnterprisesType().getValue();
    ...
    private void populateComboBox() {
        ...
        for (Enterprises.EnterprisesType type : Enterprises.EnterprisesType.values()) {
    ...
    private void initComponents() {
        ...
        backJButton.setBackground(new java.awt.Color(1, 153, 153));
        ...
        cancelJButton.setBackground(new java.awt.Color(1, 153, 153));
        ...
        submitJButton.setBackground(new java.awt.Color(1, 153, 153));
        ...
        deleteNetwork.setBackground(new java.awt.Color(1, 153, 153));
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        Enterprises.EnterprisesType type = (Enterprises.EnterprisesType) enterpriseTypeJComboBox.getSelectedItem();
        ...
        Enterprises enterprises = network.getEnterprisesDirectory().addEnterprises(name, type);
    ...
    private void deleteNetworkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteNetworkActionPerformed
        ...
        if(selectedRow >= 0)
        {
            ...
            {
                Enterprises enterprises = (Enterprises)enterpriseJTable.getValueAt(selectedRow, 0);
                for (Network network : system.getNetworkList()) 
                {
                for (Enterprises e : network.getEnterprisesDirectory().getEnterprisesList())
                {
                 if(e.getEnterprisesType().getValue().equals(enterprises.getEnterprisesType().getValue()))
                 {
                  if(enterprises.getName().equals(e.getName()))  
                 {
                   entToBeDeleted = e;
                 }
                 }
