...
public class ManageUser extends javax.swing.JPanel {
    ...
    public ManageUser(JPanel container, Enterprises enterprises, User user) {
        initComponents();
...
//        Color c2 = Color.white;
     ...
     public void populateOrganizationComboBox(){
        ...
        for(Organizations organizations :  enterprises.getOrganizationsDirectory().getOrganizationsList()){
            if(!(organizations.getName().equals("Helper Organization")) && 
                    !(organizations.getName().equals("Admin")) &&
                    !(organizations.getName().equals("HelpSeeker Organization")))
            {
            organizationJComboBox.addItem(organizations);
            }
        }
    ...
    public void populateEmployeeComboBox(Organizations organizations){
       ...
       if(!(organizations.getName().equals("Helper Organization")) && 
                    ...
                    !(organizations.getName().equals("HelpSeeker Organization")))
          {
          for (Person employee : organizations.getPersonDirectory().getPersonList()){
            employeeJComboBox.addItem(employee);   
          }
        }
     }
    
    private void populateRoleComboBox(Organizations organizations){
        roleJComboBox.removeAllItems();
        for (Roles roles : organizations.getSupportedRole()){
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
       try
       {
        ...
        User account = organizations.getUserDirectory().addUser(userName, password, person, roles);
        account.setNetwork((Network)user.getNetwork());
    ...
    private void organizationJComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_organizationJComboBoxActionPerformed
        ...
        if (organizations != null){
            populateEmployeeComboBox(organizations);
            populateRoleComboBox(organizations);
        }
