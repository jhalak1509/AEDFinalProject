...
public class ManageOrganizations extends javax.swing.JPanel {
     ...
     */
    public ManageOrganizations(JPanel userProcessContainer, Enterprises enterprises) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.enterprises = enterprises;
        this.directory = enterprises.getOrganizationsDirectory();
...
//        Color c2 = Color.white;
    ...
    public void populateOrganizationComboBox()
    {
      ...
      organizationJComboBox.removeAllItems();
            ...
            if(enterprises.getEnterprisesType().getValue().equals(EnterprisesType.Charity.getValue()))
            {
              organizationJComboBox.addItem(Type.Sponsor);
            }
            else if(enterprises.getEnterprisesType().getValue().equals(EnterprisesType.HealthOnboard.getValue()))
            {
             organizationJComboBox.addItem(Type.Case);  
             organizationJComboBox.addItem(Type.Manager); 
            }
            else if(enterprises.getEnterprisesType().getValue().equals(EnterprisesType.Ministry.getValue()))
            {
             organizationJComboBox.addItem(Type.Chief);  
            }
            else if(enterprises.getEnterprisesType().getValue().equals(EnterprisesType.University.getValue()))
            {
            organizationJComboBox.addItem(Type.Helper);     
            organizationJComboBox.addItem(Type.Transportation);
            }
            else if(enterprises.getEnterprisesType().getValue().equals(EnterprisesType.Hospital.getValue()))
            {
    ...
    private void populateOrganizationTable(){
        ...
        for (Organizations organizations : directory.getOrganizationsList()){
            Object[] row = new Object[2];
            row[0] = organizations.getOrgId();
            row[1] = organizations;
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
       ...
       JOptionPane.showMessageDialog(this, "Please select a organization!", "warning",JOptionPane.PLAIN_MESSAGE);
        ...
        for(Organizations org: directory.getOrganizationsList())
        {
    ...
    private void deleteNetworkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteNetworkActionPerformed
        ...
        if(selectedRow >= 0)
        {
            ...
            if(dialogResult == JOptionPane.YES_OPTION)
            {
                ...
                Organizations org = (Organizations)organizationJTable.getValueAt(selectedRow, 1);
